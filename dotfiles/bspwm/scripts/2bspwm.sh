...
border_width_current=16

# half if even, 1px to outer if odd
border_width_in_normal=$(( border_width_current/4 ))
...
border_color_in_normal=453637
border_color_out_normal=1f1f20
border_color_in_focused=ac895a
border_color_out_focused=1f1f20
